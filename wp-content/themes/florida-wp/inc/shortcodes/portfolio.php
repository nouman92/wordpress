...
function webnus_portfolio($attributes, $content){
...
?>
 ...
 <?php  if( is_numeric($paged) && $paged > 0){ ?>
     <br class="clear">
   <hr class="vertical-space2">
	  <?php 
...
add_shortcode("portfolio", "webnus_portfolio");
?>