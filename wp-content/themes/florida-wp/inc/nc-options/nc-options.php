...
//Google Map
    $sections[] = array(
        'icon' => NHP_OPTIONS_URL . 'img/admin-map.png',
        'title' => __('Google Map', WEBNUS_TEXT_DOMAIN),
        'fields' => array(
            array(
                'id'        => 'webnus_google_map_api',
                'type'      => 'text',
                'title'     => esc_html__( 'API key', WEBNUS_TEXT_DOMAIN ),
                'sub_desc'  => wp_kses( __('You should create an API for yourself and put code here. red below link to more info:  <a href="https://console.developers.google.com/flows/enableapi?apiid=maps_backend,geocoding_backend,directions_backend,distance_matrix_backend,elevation_backend,places_backend&keyType=CLIENT_SIDE&reusekey=true" target="_blank">Here</a><br><br>', WEBNUS_TEXT_DOMAIN), $kses ),
            ),
            array(
                'title'     => esc_html__( 'Display Sign in button', WEBNUS_TEXT_DOMAIN ),
                'subtitle'  => wp_kses( __('You can see Sign In button <a href="https://developers.google.com/maps/documentation/javascript/examples/save-simple" target="_blank">Here</a><br/><br/>', WEBNUS_TEXT_DOMAIN), $kses ),
                'id'        => 'webnus_google_map_api_sign_in',
                'type'      => 'button_set',
                'options' => array(
                    '0' => __('Hide', WEBNUS_TEXT_DOMAIN),
                    '1' => __('Show', WEBNUS_TEXT_DOMAIN),
                    ),
                'std' => '1',
            ),
        )
