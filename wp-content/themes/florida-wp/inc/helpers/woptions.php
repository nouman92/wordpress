...
if (!class_exists('webnus_options')) {
	...
	class webnus_options {
		...
		/***		Google Map
		 ...
		 function webnus_google_map_api() {
			$thm_options = get_option('webnus_options');

			return isset($thm_options['webnus_google_map_api']) ? $thm_options['webnus_google_map_api'] : null;
		}

		function webnus_google_map_api_sign_in() {
			$thm_options = get_option('webnus_options');

			return isset($thm_options['webnus_google_map_api_sign_in']) ? $thm_options['webnus_google_map_api_sign_in'] : null;
		}
