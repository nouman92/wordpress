...
vc_map( array(
  ...
  "params" => array(
    ...
    array(
	  ...
	  "dependency"=>array('element'=>'row_type','value'=>array('2','5'))
    ),
     array(
      "type" => "dropdown",
    ...
    array(
		"type"=>'textfield',
		"heading"=>__('Background Video', 'WEBNUS_TEXT_DOMAIN'),
	 ...
	 array(
		...
		"value"=>array('MP4'=>'video/mp4','WebM'=>'video/webm','Ogg'=>'video/ogg'),
		"description" => __( "Background video URL (full path with http://)", 'WEBNUS_TEXT_DOMAIN'),
		"dependency"=>array('element'=>'row_type','value'=>array('5'))
	...
	array(
		"type"=>'dropdown',
		"heading"=>__('Foreground Pattern', 'WEBNUS_TEXT_DOMAIN'),
